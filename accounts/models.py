...
class UserAccount(models.Model):
    ...
    gender = models.CharField(max_length=10, choices=GENDER_TYPE, blank=True, default="")
    user_type = models.CharField(max_length=10, choices=USER_TYPE, blank=True, default="")
